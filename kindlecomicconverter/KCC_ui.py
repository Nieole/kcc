...
class Ui_mainWindow(object):
    ...
    def retranslateUi(self, mainWindow):
...
#endif // QT_CONFIG(tooltip)
        self.directoryButton.setText(QCoreApplication.translate("mainWindow", u"\u6dfb\u52a0\u56fe\u50cf\u6587\u4ef6\u5939", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.preserveMarginLabel.setToolTip(QCoreApplication.translate("mainWindow", u"<html><head/><body><p>\u8ba1\u7b97\u88c1\u526a\u8fb9\u754c\u540e\uff0c&quot;\u4fdd\u7559&quot;\u6307\u5b9a\u7684\u767e\u5206\u6bd4\u91cf.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.preserveMarginLabel.setText(QCoreApplication.translate("mainWindow", u"\u4fdd\u7559\u8fb9\u8ddd %", None))
        self.croppingPowerLabel.setText(QCoreApplication.translate("mainWindow", u"\u88c1\u526a\u7a0b\u5ea6:", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.mangaBox.setToolTip(QCoreApplication.translate("mainWindow", u"<html><head/><body><p style='white-space:pre'>\u542f\u7528\u65e5\u5f0f\u88c5\u8ba2\u6a21\u5f0f\uff08\u4ece\u53f3\u5411\u5de6\u7ffb\u9875\uff09</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.mangaBox.setText(QCoreApplication.translate("mainWindow", u"\u6f2b\u753b\u6a21\u5f0f", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.gammaBox.setToolTip(QCoreApplication.translate("mainWindow", u"<html><head/><body><p style='white-space:pre'>\u7981\u7528\u81ea\u52a8 Gamma \u6821\u6b63.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.colorBox.setToolTip(QCoreApplication.translate("mainWindow", u"<html><head/><body><p style='white-space:pre'>\u7981\u7528\u7070\u5ea6\u8f6c\u6362.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.colorBox.setText(QCoreApplication.translate("mainWindow", u"\u5f69\u8272\u6a21\u5f0f", None))
#if QT_CONFIG(tooltip)
        self.qualityBox.setToolTip(QCoreApplication.translate("mainWindow", u"<html><head/><body><p style='white-space:pre'><span style=\" font-weight:600; text-decoration: underline;\">\u672a\u9009\u4e2d - 4 \u9762\u677f<br/></span>\u5206\u522b\u7f29\u653e\u6bcf\u4e2a\u89d2\u843d.</p><p style='white-space:pre'><span style=\" font-weight:600; text-decoration: underline;\">\u534a\u9009 - 2 \u9762\u677f<br/></span>\u4ec5\u7f29\u653e\u9875\u9762\u7684\u9876\u90e8\u548c\u5e95\u90e8.</p><p><span style=\" font-weight:600; text-decoration: underline;\">\u9009\u4e2d - 4 \u9ad8\u8d28\u91cf \u9762\u677f<br/></span>\u5206\u522b\u653e\u5927\u6bcf\u4e2a\u89d2\u3002\u5c1d\u8bd5\u63d0\u9ad8\u653e\u5927\u8d28\u91cf\u3002\u66f4\u591a\u8be6\u60c5\u8bf7\u67e5\u770b\u7ef4\u57fa\u767e\u79d1\u3002</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.fileFusionBox.setToolTip(QCoreApplication.translate("mainWindow", u"<html><head/><body><p>\u5c06\u6240\u6709\u9009\u5b9a\u7684\u6587\u4ef6\u5408\u5e76\u5230\u4e00\u4e2a\u6587\u4ef6\u4e2d. (\u6709\u52a9\u4e8e\u5c06\u7ae0\u8282\u5408\u5e76\u6210\u5377.)</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.outputSplit.setToolTip(QCoreApplication.translate("mainWindow", u"<html><head/><body><p style='white-space:pre'><span style=\" font-weight:600; text-decoration: underline;\">\u672a\u9009\u4e2d - \u81ea\u52a8\u6a21\u5f0f<br/></span>The output will be split automatically.</p><p style='white-space:pre'><span style=\" font-weight:600; text-decoration: underline;\">\u9009\u4e2d - \u5377\u6a21\u5f0f<br/></span>\u6bcf\u4e2a\u5b50\u76ee\u5f55\u90fd\u5c06\u88ab\u89c6\u4e3a\u4e00\u4e2a\u5355\u72ec\u7684\u5377.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.reduceRainbowBox.setToolTip(QCoreApplication.translate("mainWindow", u"\u901a\u8fc7\u7565\u5fae\u6a21\u7cca\u56fe\u50cf\u6765\u51cf\u5c11\u5f69\u8272 eink \u4e0a\u7684\u5f69\u8679\u7eb9\u6548\u679c", None))
#endif // QT_CONFIG(tooltip)
        self.reduceRainbowBox.setText(QCoreApplication.translate("mainWindow", u"\u5f69\u8679\u7eb9\u6a21\u7cca\u4fee\u590d", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.comicinfoTitleBox.setToolTip(QCoreApplication.translate("mainWindow", u"\u4eceComicInfo.xml\u5199\u5165\u6807\u9898", None))
#endif // QT_CONFIG(tooltip)
        self.comicinfoTitleBox.setText(QCoreApplication.translate("mainWindow", u"ComicInfo\u6807\u9898", None))
        ...
        self.chunkSizeWarnLabel.setText(QCoreApplication.translate("mainWindow", u"\u5927\u4e8e\u9ed8\u8ba4\u503c\u53ef\u80fd\u4f1a\u5bfc\u81f4\u65e7\u7248\u9605\u8bfb\u5668\u51fa\u73b0\u6027\u80fd\u95ee\u9898\u3002", None))
    # retranslateUi
